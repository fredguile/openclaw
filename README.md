# 🦞 OpenClaw — Personal AI Assistant (forked)
...
<p align="center">
  <a href="https://github.com/fredguile/openclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/fredguile/openclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/fredguile/openclaw/releases"><img src="https://img.shields.io/github/v/release/fredguile/openclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
...
```bash
npm install -g @fredguile/openclaw@latest
# or: pnpm add -g @fredguile/openclaw@latest
...
- **verified**: fork stable releases (`vYYYY.M.D-verified.N`), npm dist-tag `latest`. Upstream version integrated, verified with fork features, and released.
...
This fork is maintained by [@fredguile](https://github.com/fredguile) and published as [`@fredguile/openclaw`](https://www.npmjs.com/package/@fredguile/openclaw).
